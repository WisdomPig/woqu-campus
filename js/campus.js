...
$(function(){$(".pages").parallax({direction:"vertical",swipeAnim:"cover",drag:true,loading:false,indicator:false,arrow:false,onchange:function(a,b,c){$(".job_detail_wrapper").hide();$("#current").html(a+1)}});$(".job_btn").click(function(){$(this).next().show()});$(".close").click(function(){$(this).parent().hide()});function createCanvas(d,c,a){var b={};b.node=document.createElement("canvas");b.context=b.node.getContext("2d");b.node.width=c||100;b.node.height=a||100;d.appendChild(b.node);return b}function init(c,e,a,f){var d=createCanvas(c,e,a);var b=d.context;b.fillCircle=function(h,j,g,i){this.fillStyle=i;this.beginPath();this.moveTo(h,j);this.arc(h,j,g,0,Math.PI*2,false);this.fill()};b.clearTo=function(g){b.fillStyle=g;b.fillRect(0,0,e,a)};b.clearTo(f||"#909090");$(d.node).on("touchmove",function(i){i.stopPropagation();if(!d.isDrawing){return}var h=i.changedTouches[0].clientX-$(i.target).offset().left+70;var k=i.changedTouches[0].clientY-$(i.target).offset().top+100;var g=80;var j="#ff0000";b.globalCompositeOperation="destination-out";b.fillCircle(h,k,g,j)});$(d.node).on("touchstart",function(g){g.stopPropagation();d.isDrawing=true});$(d.node).on("touchend",function(g){g.stopPropagation();d.isDrawing=false})}$(".mask").each(function(){init(this,256,284,"#909090")});});